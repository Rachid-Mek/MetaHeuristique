...
public class Main {
    public static void main(String[] args) {
        ...
        for (int[] arr : data) {
            ...
            System.out.println("temps d'execution:"+partitionAStar.excutionTime.toSeconds()+"s");

            i++;
            //System.out.println("Execution time: " + partitionAStar.excutionTime.toSeconds() + "s");
            String row = arr.length + "," + partitionAStar.excutionTime.toSeconds() + "\n";
            rows.add(row);
